...
public class ChunkLoaderTimeGui extends Gui {
    ...
    private static final double PRICE_PER_HOUR = 50_000D;
    ...
    public void redraw() {
        ...
        setItem(8, ItemStackBuilder.of(Material.GOLD_BLOCK)
                ...
                .build(() -> {
                    ...
                    handleTimeAddition(timeToAdd, loader);
        ...
        DURATION_PRICE_MAP.forEach((duration, pair) -> {
            ...
            addItem(ItemStackBuilder.of(Material.PAPER)
                    ...
                    .build(() -> {
                        ...
                        handleTimeAddition(duration, loader);
    ...
    private void handleTimeAddition(Duration timeToAdd, ChunkLoader loader) {
        if (loader.isWaiting()) {
            ...
            loader.setTimeLeft(timeToAdd.toSeconds());
